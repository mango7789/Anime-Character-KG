...
FIELD_TO_RELATION_ANIME = {
    "作者": {"relation": "OriginalAuthor", "type": "Person"},
    "原作": {"relation": "OriginalAuthor", "type": "Person"},
    "出版社": {"relation": "Publisher", "type": "Organization"},
    "发表期间": {"relation": "PublicationPeriod", "type": "Time"},
    "制作公司": {"relation": "ProductionCompany", "type": "Organization"},
    "监督": {"relation": "ChiefDirector", "type": "Person"},
    "系列构成": {"relation": "SeriesComposition", "type": "Person"},
    "角色设计": {"relation": "CharacterDesigner", "type": "Person"},
    "音乐": {"relation": "Music", "type": "Person"},
    "首播时间": {"relation": "FirstReleaseDate", "type": "Time"},
}

FIELD_TO_RELATION_ROLE = {
    # ===== Basic Attributes =====
    "别号": {"relation": "Alias", "type": "Literal"},
    "性别": {"relation": "Gender", "type": "Literal"},
    "生日": {"relation": "BirthDate", "type": "Time"},
    "身高": {"relation": "Height", "type": "Numeric"},
    "体重": {"relation": "Weight", "type": "Numeric"},
    "瞳色": {"relation": "EyeColor", "type": "Literal"},
    "发色": {"relation": "HairColor", "type": "Literal"},
    "出身地区": {"relation": "Origin", "type": "Location"},
    "活动范围": {"relation": "ActiveArea", "type": "Location"},
    "个人状态": {"relation": "LivingStatus", "type": "Literal"},
    # ===== Group / Affiliation =====
    "所属团体": {"relation": "MemberOf", "type": "Group"},
    "担当": {
        "relation": "HasPosition",
        "type": "Literal",
    },
    # ===== Tags =====
    "萌点": {"relation": "CharacterTag", "type": "Tag"},
}
